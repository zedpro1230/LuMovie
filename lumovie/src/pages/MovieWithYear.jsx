    ...
    const fetchSeries = async () => {
      try {
        const response = await axios.get(
          `https://phimapi.com/v1/api/nam/${type.type}?page=${page}&sort_field=_id&sort_type=asc&sort_lang=&category=&country=&limit=20`
        );
  ...
  return (
    <div className="w-[95%] ml-auto mr-auto flex items-center justify-center flex-col gap-5 font-manrope">
      ...
      <div className="mt-[150px] ">
        ...
        >
          Tổng Hợp Phim Theo Năm {type.type}
        </h1>
      </div>
      {series !== null && (
        <ul
