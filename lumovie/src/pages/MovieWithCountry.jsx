    ...
    const fetchSeries = async () => {
      try {
        const response = await axios.get(
          `https://phimapi.com/v1/api/quoc-gia/${type.type}?page=${page}&sort_field=_id&sort_type=asc&sort_lang=&category=&year=&limit=20`
        );
...
export default MovieWithCountry;
