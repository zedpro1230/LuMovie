    ...
    const fetchSeries = async () => {
      try {
        const response = await axios.get(
          `https://phimapi.com/v1/api/the-loai/${type.type}?page=${page}&sort_field=_id&sort_type=asc&sort_lang=&country=&year=&limit=20`
        );
